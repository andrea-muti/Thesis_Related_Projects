...
public class NodeReadLineChart extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        stage.setTitle("Node Read Latencies");

        final NumberAxis xAxis = new NumberAxis();
        final NumberAxis yAxis = new NumberAxis();

        xAxis.setLabel("Number of Random Read Requests");
		yAxis.setLabel("Nodes Read Latency [milliseconds]");

        final LineChart<Number,Number> lineChart = new LineChart<Number,Number>(xAxis,yAxis);
       
        lineChart.setTitle("Nodes Read Latency vs Number of Read Requests");
    ...
    public static void main(String[] args) {
    	if(args.length<2){
    		System.err.println("Error: path to the mean node read latencies and to 99.9th percentile "
