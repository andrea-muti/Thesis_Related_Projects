...
public class ThroughputDuringJoining extends Application {
	...
	@Override public void start(Stage stage) {
        ...
        stage.setTitle("Throughput during joining");
        ...
        lineChart.setTitle("Throughput during Joining and Cleanups");
