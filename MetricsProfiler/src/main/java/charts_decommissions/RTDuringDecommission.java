...
public class RTDuringDecommission extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        stage.setTitle("Response Time - 6 to 5 nodes");
        ...
        lineChart.setTitle("Response Time - 6 to 5 nodes");
        lineChart.setCreateSymbols(false);  
            
        add_line_to_chart(lineChart, file_paths.get(0), "6->5 nodes", 6);
        //add_line_to_chart(lineChart, file_paths.get(1), "5->4 nodes", 5);
        //add_line_to_chart(lineChart, file_paths.get(2), "4->3 nodes", 4);
	...
	private void add_line_to_chart(LineChart<Number, Number> lineChart, String file_path, String name, int num) {    	
		...
		try {
			...
			while(line!=null){
				...
				seriesnodi.getData().add(new XYChart.Data<Number, Number>(time, nodi*60));
				time=time+15;
